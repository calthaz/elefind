 ...
 * and exchanges data with both the SketchPad and the Manager
 * @author asus-pc
 *
 */
...
public class SearchGUI extends JFrame implements ActionListener,ListSelectionListener {
	...
	public SearchGUI(Manager man){
	    ...
	    resultT = new JTable((manager).tableModel);//(QueryManager) how to cast it into different thing?
        ...
        System.out.println(resultT.getColumnCount()+","+resultT.getRowCount());
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==start){
			...
			//resultT.clearSelection();?? why?
			pad.loadDraft(manager.getImpr());
